...
**Problem:** The public event page (F-4.1) is the primary entry point for attendees. Most attendees discover and buy tickets on a phone (`prd.md` ASM-3). If the page does not work well on a small screen — text too small, buttons hard to tap, horizontal scrolling required — attendees abandon the purchase. The current F-4.1 implementation focuses on desktop layout and content completeness; mobile experience is not yet addressed.
